...
if($userrank["SUPERADMIN"] !== "on"){ echo '<meta http-equiv="refresh" content="0;URL=?page=error.403">'; die(); } 
    ...
    if(isset($_POST['edit_profile_account'])){
      ...
      if(empty($_POST['github'])){ $_POST['github'] = ""; }
      if(empty($_POST['discord'])){ $_POST['discord'] = ""; }
  ...
  if(!empty($_POST['pass']) AND !empty($_POST['passVerify'])){
    ...
    }else{ $error = "<div class='alert alert-danger'><b><i class='fas fa-exclamation-circle text-danger'></i></b> Passwords does not match !</div>"; }


      }else{ $error = '<div class="alert alert-danger"><strong><i class="fas fa-exclamation-circle"></i></strong> Please enter all fields.</div>'; }
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        <td>
                          <?php if($userinforank['PERMISSION_LEVEL'] > $_Config_['General']['staff_permission_level']){ echo '<i class="fas fa-hammer text-danger"></i>'; } ?>
                          <?php if($userinforank['SUPERADMIN'] == "on"){ echo '<i class="fas fa-crown text-warning"></i>'; } ?>
                  ...
                  <div class="col-6">
                    ...
                    <b>ACCOUNT EDITION</b><br><br>
                      <div class="row">
                          ...
                          <div class="d-grid gap-2"><label>Avatar</label><form method="post"><button type="submit" class="btn btn-danger btn-sm" name="resetavatar"><i class="fas fa-portrait"></i> Reset user avatar</button></form><br>
                            <?php if($r['STATUS'] == 0){ ?>
                            <label>Avatar</label><form method="post"><button type="submit" class="btn btn-success btn-sm" name="validateemail"><i class="fas fa-check"></i> Validate user's email</button></form>
                            <?php } ?>
                ...
                <div class="row">
                          ...
                          <div class="col-7">
                            ...
                            <div class="input-group mb-3">
                              <select class="form-control border-primary" name="status">
                                <option <?php if($r['STATUS'] == "0") { echo "selected"; } ?> value="0">Confirmation waiting</option>
                                <option <?php if($r['STATUS'] == "1") { echo "selected"; } ?> value="1">Active</option>
                                <option <?php if($r['STATUS'] == "2") { echo "selected"; } ?> value="2">Disabled</option>
                              </select>
                            ...
                            <div class="input-group mb-3">
                              <select class="form-control border-primary" name="rank">
                                ...
                                <option <?php if($r['RANK_ID'] == $si['id']) { echo "selected"; } ?> value="<?php echo $si['id']; ?>"><?php echo $si['NAME']; ?></option>
                                <?php } ?>
                              </select>
                            ...
                            <div class="d-grid gap-2"><label>Superadmin extension</label><form method="post"><button type="submit" class="btn btn-primary btn-sm" name="loginasaccount"><i class="fas fa-fingerprint"></i> Log in as <?php echo $r['NAMETAG']; ?></button></form></div></div>
                            </div>
                        </div>
                      </div>
                    <div class="card">
                      <div class="card-body">
                          ...
                          <div class="col-12">
                            ...
                            <form method="POST">
                              ...
                              <input type="password" name="passVerify" class="form-control border-primary"><br><hr>
                  ...
                  <div class="col-6">
                    <div class="card">
                      ...
                      <div class="card-body"><b>PROFILE INFORMATIONS</b><br><br><form method="POST">
                          <label>Github</label>
                          <div class="input-group mb-3">
                      ...
                      <button type="submit" class="btn btn-primary" name="edit_profile_account"><i class="fas fa-edit"></i> Edit</button></form>
